...
class Leader(State):
    ...
    def send_append_entries(self):
        ...
        for peer in self.volatile['cluster']:
            ...
            logger.debug('Sending %s entries to %s',
                         len(msg['entries']), peer)
